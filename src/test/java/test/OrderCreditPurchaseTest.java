...
public class OrderCreditPurchaseTest {
    ...
    @Test
    @DisplayName("(6) Negative - CreditCard - CardField One symbols")
    void shouldFailBuyByInvalidCreditCardFieldOneSymbols() {
    ...
    @Test
    @DisplayName("(25) PayCard - CreditCard - YearField - Zero")
